...
function stm_get_admin_tabs($screen='welcome') {
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="<?php echo ( 'demos' === $screen ) ? '#' : esc_url_raw( admin_url( 'admin.php?page=stm_option_options&tab=13' ) ); ?>" class="<?php echo ( 'demos' === $screen ) ? 'nav-tab-active' : ''; ?> nav-tab"><?php esc_attr_e( 'Install Demos', 'stm_domain' ); ?></a>
